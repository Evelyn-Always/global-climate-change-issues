...
pie = (
    ...
    .set_series_opts(
        tooltip_opts=opts.TooltipOpts(
            trigger="item",
            formatter="""
            <div style="font-family: Consolas; background: rgba(5,10,30,0.92); border: 2px solid #0ff2fe; padding: 12px; border-radius: 8px;">
