...
line = (
    Line(init_opts=opts.InitOpts(
        width="100%",
        height="600px",
        theme=ThemeType.DARK,  # 使用内置暗黑主题
        bg_color="rgba(10,20,30,0.8)",  # 深色渐变背景
        chart_id="tech_dashboard", # 指定图表ID便于自定义
    ))
    ...
    .add_yaxis(
        ...
        y_axis=values,
        is_smooth=True,
        symbol="emptyCircle",  # 空心圆点
        symbol_size=4,  # 更小的标记点
        ...
        itemstyle_opts=opts.ItemStyleOpts(
            border_width=2,
            border_color="rgba(0,180,255,0.8)"
        ),
